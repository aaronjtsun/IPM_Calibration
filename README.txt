...
3. Compile code using CMake
	For Linux: 'cmake .' to output CMakeLists.txt to Makefile, then 'make' to compile into executable	
	For Windows: https://cmake.org/runningcmake/
***DO NOT DELETE IPM_Calibration.cpp OR CMakeLists.txt OR PROGRAM WILL NOT BE ABLE TO COMPILE***

4. Run executable 'ipm'
	In both terminal/command line: './ipm'
